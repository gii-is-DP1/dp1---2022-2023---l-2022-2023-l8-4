...
Como administrador quiero poder ver un listado de las partidas en curso así como el creador y jugadores de cada partida, para así poder tener información diversa sobre las partidas actuales.

### Escenarios Positivos:
* **H4+E1-Información mostrada correctamente:**

Dado que estamos logueados en el sistema como administrador, cuando accedemos al enlace de las partidas actuales, entonces se muestra un listado de las partidas actuales con el nombre de cada jugador indicando, además, el creador de la partida.
...
Dado que hemos introducido información adecuada para el nuevo usuario y no hemos dejado ningún campo en blanco, cuando pulsamos el botón de sign-up, entonces se crea el jugador, se almacena en el sistema y se inicia sesión con dicho usuario.
